...
<section class="nav-specsheet" data-sr-reveal aria-label="Navigator cloth and components">
    ...
    <div class="nav-specsheet__panel">
      ...
      <div class="nav-specsheet__grid">
        ...
        <div class="nav-specsheet__text">
          <h2 class="nav-specsheet__title sr-item">Cloth Selection &amp; Construction</h2>
