...
<link rel="stylesheet" href="../Covers-12.WindowandHatchCovers/new_sail_quote/new_sail_quote.css?v=<?= $css_time ?>">
...
<script defer src="../Covers-12.WindowandHatchCovers/new_sail_quote/new_sail_quote.js?v=<?= $js_time ?>"></script>
