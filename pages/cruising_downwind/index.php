...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Axia Blue Line Downwind Sails | Ullman Sails</title>
  ...
  <body>
    ...
    <?php include __DIR__ . "/../cruising_downwind/new_sail_quote/new_sail_quote.php"; ?>


    <?php include __DIR__ . "/../general/arrows_up_down/arrows_up_down.php" ?>

    <?php include __DIR__ . "/../cruising_downwind/0_slider/slider.php";?>
    ...
    <?php include __DIR__ . "/12_sub_models/sub_models.php" ?>
