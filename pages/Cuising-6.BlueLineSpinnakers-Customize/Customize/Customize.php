...
<script src="<?php echo esc_url(get_template_directory_uri() . '/pages/Cuising-6.BlueLineSpinnakers-Customize/Customize/customize.js?v=' . assetVersion($customizeJs)); ?>"></script>
