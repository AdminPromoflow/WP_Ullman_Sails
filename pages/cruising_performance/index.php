...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Performance Series | Ullman Sails</title>
    ...
    :root { --series-section-subtitle: "Performance Series"; }
  ...
  <body>
    ...
    <?php include __DIR__ . "/../cruising_performance/new_sail_quote/new_sail_quote.php"; ?>
    <?php include __DIR__ . "/../general/arrows_up_down/arrows_up_down.php" ?>
    <?php include __DIR__ . "/../cruising_performance/0_slider/slider.php";?>
    ...
    <?php include __DIR__ . "/11_expedition_extreme_environment/extreme_environment.php" ?>
