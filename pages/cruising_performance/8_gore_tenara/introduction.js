...
(() => {
  ...
  const sections = document.querySelectorAll('.sailing-types-introduction[data-sr-reveal]');
  ...
  // Fallbacks (sin IO o con reduced motion): revela inmediatamente
