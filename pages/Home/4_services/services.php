    ...
    <div class="events-list">
      ...
      <article class="event-card">
        ...
        <div class="event-card__action">
          <a href="<?php echo esc_url(ullman_page_url('services_1_sails_repair')); ?>" class="st-btn st-btn-dark">See more</a>
        </div>
      </article>
      ...
      <article class="event-card">
        ...
        <div class="event-card__action">
          <a href="<?php echo esc_url(ullman_page_url('services_2_sails_cleaning')); ?>" class="st-btn st-btn-dark">See more</a>
        </div>
      </article>
      ...
      <article class="event-card">
        ...
        <div class="event-card__action">
          <a href="<?php echo esc_url(ullman_page_url('services_3_canvas_repair')); ?>" class="st-btn st-btn-dark">See more</a>
        </div>
      </article>
