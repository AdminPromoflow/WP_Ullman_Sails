...
<html lang="en" dir="ltr">
  <head>
    ...
    :root { --series-section-subtitle: "The Axia Series – Red Line"; }
  ...
  <body>
    ...
    <?php include __DIR__ . "/../racing_red_line_series/new_sail_quote/new_sail_quote.php"; ?>


    <?php include __DIR__ . "/../general/arrows_up_down/arrows_up_down.php" ?>

    <?php include __DIR__ . "/../racing_red_line_series/0_slider/slider.php";?>
    <?php include __DIR__ . "/navigation/navigation.php"?>

    <?php include __DIR__ . "/1_introduction/introduction.php";?>
    <?php include __DIR__ . "/customize_your_own_sail/customize_your_own_sail.php" ?>
    ...
    <?php include __DIR__ . "/9_engineering_for_extreme_environments/engineering_for_extreme_environments.php" ?>
    <?php include __DIR__ . "/10_sub_models/sub_models.php" ?>
